...
public class Controller {
	...
	public String login(@RequestParam String fname, 
		...
		try {
			System.out.println("testname:::"+fname);
	...
	public String SaveData( 
			Model model, @RequestBody  User User, @RequestBody  String fname, @RequestBody String address)  {
				System.out.println("Hello addresss :::" +User);
               // System.out.println("Hello addresss :::" + fname);
				// System.out.println("input Form:::" + inputForm);

				// JSONParser parser = new JSONParser(inputForm);
				// System.out.println("testJson:"+parser.toString());
